...
ALLOWED_HOSTS = ['edvoyagechat.pythonanywhere.com', 'localhost', '127.0.0.1']
...
# Static current user used by the frontend (change as needed)
STATIC_CURRENT_USER_EMAIL = 'wow@gmail.com'
